(function() {
  ...
  window.countryDataFiles['mesir'] = {
    names: { id: 'Mesir', en: 'Egypt', ja: 'エジプト', ko: '이집트', zh: '埃及' },
    flag: '🇪🇬',
    articles: [
      {
        id: 'mesir-imf-cairkan-2-3miliar-26feb2026',
        langs: {
          id: {
            title: 'IMF Cairkan 2,3 Miliar Dolar untuk Mesir Usai Reformasi Ekonomi Dinilai Berhasil Stabilkan Perekonomian',
            desc: 'Dana Moneter Internasional (IMF) menyetujui pencairan sekitar 2,3 miliar dolar AS untuk Mesir pada 26 Februari 2026 setelah menyelesaikan tinjauan kelima dan keenam program pinjaman 46 bulan.',
            content: '<p>Dana Moneter Internasional (IMF) pada 26 Februari 2026 mengumumkan penyelesaian tinjauan kelima dan keenam terhadap program pinjaman 46 bulan Mesir, membuka jalan bagi pencairan dana sekitar 2,3 miliar dolar AS. Pencairan ini terdiri dari sekitar 2 miliar dolar dalam kerangka program pinjaman utama serta tambahan 273 juta dolar dari fasilitas pendanaan terkait.</p><p>Laporan IMF menyebutkan bahwa pemulihan ekonomi Mesir yang berbasis luas telah mendorong pertumbuhan Produk Domestik Bruto (PDB) riil mencapai 4,4% pada tahun fiskal 2024/2025, sementara inflasi mengalami penurunan signifikan menjadi 11,9% pada Januari 2026, jauh membaik dibandingkan periode-periode sebelumnya yang sempat mencatatkan inflasi di atas 66%.</p><p>Meski demikian, tantangan struktural Mesir masih besar, dengan utang luar negeri negara tersebut tercatat mencapai 169 miliar dolar AS, sementara kewajiban pembayaran utang luar negeri pada 2026 saja diperkirakan mencapai 27 miliar dolar — sebuah beban fiskal yang menyerap lebih dari separuh total pendapatan negara untuk pembayaran utang dan bunga.</p><p>Pencairan dana IMF ini menjadi sinyal positif bagi investor internasional mengenai komitmen Mesir terhadap reformasi ekonomi struktural, termasuk kebijakan nilai tukar mengambang yang telah diterapkan sebelumnya. Namun para ekonom tetap mengingatkan bahwa keberlanjutan reformasi jangka panjang akan sangat menentukan stabilitas ekonomi Mesir ke depan, terutama di tengah tekanan geopolitik regional yang masih berlangsung.</p>',
            source: 'Reuters',
            sourceUrl: 'https://www.reuters.com/world/africa/imf-completes-egypt-reviews-unlocking-about-23-billion-2026-02-26/',
            sourceSnippet: 'IMF completes Egypt reviews, unlocking about $2.3 billion — Reuters, February 26, 2026',
            source2: 'IMF',
            sourceUrl2: 'https://www.imf.org/-/media/files/publications/cr/2026/english/1egyea2026001.pdf',
            sourceSnippet2: 'Arab Republic of Egypt: real GDP growth 4.4%, inflation declined to 11.9% in January 2026 — IMF Country Report',
            source3: 'Times of Israel Blogs',
            sourceUrl3: 'https://blogs.timesofisrael.com/sisi-has-run-this-con-seven-times-washington-keeps-falling-for-it/',
            sourceSnippet3: "Egypt carries $169 billion in external debt, owes $27 billion in debt service in 2026 — Times of Israel Blogs"
          },
          en: {
            title: 'IMF Unlocks $2.3 Billion for Egypt After Economic Reforms Deemed Successful in Stabilizing the Economy',
            desc: 'The International Monetary Fund (IMF) approved the release of about $2.3 billion for Egypt on February 26, 2026, after completing the fifth and sixth reviews of its 46-month loan program.',
            content: "<p>The International Monetary Fund (IMF) announced on February 26, 2026, the completion of the fifth and sixth reviews of Egypt's 46-month loan program, paving the way for the release of about $2.3 billion. This disbursement consists of about $2 billion under the main loan program framework plus an additional $273 million from a related funding facility.</p><p>The IMF report noted that Egypt's broad-based economic recovery had lifted real Gross Domestic Product (GDP) growth to 4.4% in fiscal year 2024/2025, while inflation declined markedly to 11.9% in January 2026, a significant improvement compared to previous periods that had recorded inflation above 66%.</p><p>Nevertheless, Egypt's structural challenges remain substantial, with the country's external debt recorded at $169 billion, while external debt service obligations in 2026 alone are estimated at $27 billion — a fiscal burden absorbing more than half of total state revenue for debt and interest payments.</p><p>This IMF disbursement serves as a positive signal to international investors regarding Egypt's commitment to structural economic reform, including the flexible exchange rate policy previously implemented. However, economists continue to caution that the sustainability of long-term reforms will greatly determine Egypt's future economic stability, particularly amid ongoing regional geopolitical pressures.</p>",
            source: 'Reuters',
            sourceUrl: 'https://www.reuters.com/world/africa/imf-completes-egypt-reviews-unlocking-about-23-billion-2026-02-26/',
            sourceSnippet: 'IMF completes Egypt reviews, unlocking about $2.3 billion — Reuters, February 26, 2026',
            source2: 'IMF',
          ...
          ja: {
            title: 'IMF、経済安定化の改革成功を評価しエジプトに23億ドル拠出',
            desc: 'IMFは2026年2月26日、46ヶ月融資プログラムの第5・第6次レビュー完了を受け、エジプトに約23億ドルの拠出を承認した。',
            content: '<p>国際通貨基金（IMF）は2026年2月26日、エジプトの46ヶ月融資プログラムの第5次・第6次レビュー完了を発表し、約23億ドルの拠出への道を開きました。この拠出は主要融資プログラム枠組みの下での約20億ドルと、関連融資ファシリティからの追加2億7,300万ドルで構成されます。</p><p>IMFの報告書は、エジプトの広範な経済回復により2024/2025会計年度の実質GDP成長率が4.4%まで上昇し、インフレ率は2026年1月に11.9%へと著しく低下、66%を超えていた過去の時期と比較し大幅な改善を見せたと指摘しました。</p><p>しかしながらエジプトの構造的課題は依然として大きく、同国の対外債務は1,690億ドルに達し、2026年単年の対外債務返済義務だけで270億ドルと推計され、国家歳入総額の半分以上を債務・利子返済に充てる財政負担となっています。</p>',
            source: 'Reuters',
            sourceUrl: 'https://www.reuters.com/world/africa/imf-completes-egypt-reviews-unlocking-about-23-billion-2026-02-26/',
            sourceSnippet: 'IMF、エジプトのレビュー完了、約23億ドル拠出へ — Reuters、2026年2月26日',
            source2: 'IMF',
            sourceUrl2: 'https://www.imf.org/-/media/files/publications/cr/2026/english/1egyea2026001.pdf',
            sourceSnippet2: 'エジプト・アラブ共和国：実質GDP成長率4.4%、2026年1月インフレ率11.9%に低下 — IMF国別報告書'
          },
          ko: {
            title: 'IMF, 경제 안정화 개혁 성공 평가하며 이집트에 23억 달러 지원',
            desc: 'IMF는 2026년 2월 26일 46개월 대출 프로그램의 5차 및 6차 검토 완료를 계기로 이집트에 약 23억 달러 지원을 승인했다.',
            content: '<p>국제통화기금(IMF)은 2026년 2월 26일 이집트의 46개월 대출 프로그램에 대한 5차 및 6차 검토 완료를 발표하며 약 23억 달러 지원의 길을 열었습니다. 이 지원금은 주요 대출 프로그램 체계 하의 약 20억 달러와 관련 자금 지원 시설의 추가 2억 7,300만 달러로 구성됩니다.</p><p>IMF 보고서는 이집트의 광범위한 경제 회복이 2024/2025 회계연도 실질 국내총생산(GDP) 성장률을 4.4%까지 끌어올렸으며, 인플레이션은 2026년 1월 11.9%로 눈에 띄게 감소, 66%를 넘었던 이전 기간과 비교해 크게 개선되었다고 밝혔습니다.</p><p>그럼에도 이집트의 구조적 과제는 여전히 크며, 이 나라의 대외 부채는 1,690억 달러에 달하고, 2026년 한 해만 대외 부채 상환 의무가 270억 달러로 추산되어 국가 총수입의 절반 이상을 부채 및 이자 상환에 흡수하는 재정 부담이 되고 있습니다.</p>',
            source: 'Reuters',
            sourceUrl: 'https://www.reuters.com/world/africa/imf-completes-egypt-reviews-unlocking-about-23-billion-2026-02-26/',
            sourceSnippet: 'IMF, 이집트 검토 완료, 약 23억 달러 지원 예정 — Reuters, 2026년 2월 26일',
            source2: 'IMF',
            sourceUrl2: 'https://www.imf.org/-/media/files/publications/cr/2026/english/1egyea2026001.pdf',
            sourceSnippet2: '이집트 아랍공화국: 실질 GDP 성장률 4.4%, 2026년 1월 인플레이션 11.9%로 감소 — IMF 국가보고서'
          },
          zh: {
            title: 'IMF评估经济改革成功稳定局势，向埃及释放23亿美元',
            desc: '国际货币基金组织于2026年2月26日完成对埃及46个月贷款计划第五、六次审查后，批准向埃及释放约23亿美元。',
            content: '<p>国际货币基金组织（IMF）于2026年2月26日宣布完成对埃及46个月贷款计划的第五和第六次审查，为释放约23亿美元铺平了道路。这笔资金包括主要贷款计划框架下约20亿美元，以及相关融资机制的额外2.73亿美元。</p><p>IMF报告指出，埃及广泛的经济复苏推动2024/2025财年实际国内生产总值（GDP）增长率达到4.4%，而通胀率在2026年1月显著降至11.9%，相较于此前曾录得超过66%通胀率的时期大幅改善。</p><p>尽管如此，埃及的结构性挑战依然巨大，该国外债达1690亿美元，仅2026年一年的外债偿还义务估计就达270亿美元——这一财政负担吸收了国家总收入的一半以上用于偿还债务和利息。</p>',
            source: 'Reuters',
            sourceUrl: 'https://www.reuters.com/world/africa/imf-completes-egypt-reviews-unlocking-about-23-billion-2026-02-26/',
            sourceSnippet: 'IMF完成对埃及的审查，释放约23亿美元 — Reuters，2026年2月26日',
            source2: 'IMF',
            sourceUrl2: 'https://www.imf.org/-/media/files/publications/cr/2026/english/1egyea2026001.pdf',
            sourceSnippet2: '阿拉伯埃及共和国：实际GDP增长4.4%，2026年1月通胀降至11.9% — IMF国家报告'
          }
        }
      },
      {
        id: 'mesir-mekanisme-harga-bbm-triwulanan-fy2627',
        langs: {
          id: {
            title: 'Mesir Berlakukan Kembali Mekanisme Peninjauan Harga BBM Triwulanan Mulai Kuartal Pertama FY26/27',
            desc: 'Perdana Menteri Mesir Mostafa Madbouly mengumumkan pemberlakuan kembali mekanisme peninjauan harga bahan bakar minyak (BBM) secara triwulanan mulai kuartal pertama tahun fiskal 2026/2027.',
            content: '<p>Perdana Menteri Mesir Mostafa Madbouly mengumumkan bahwa pemerintah akan memberlakukan kembali mekanisme peninjauan harga bahan bakar minyak (BBM) secara otomatis dan triwulanan mulai kuartal pertama tahun fiskal 2026/2027. Kebijakan ini menandai kelanjutan agenda reformasi subsidi energi yang telah menjadi bagian penting dari program stabilisasi ekonomi Mesir dalam beberapa tahun terakhir.</p><p>Komite penetapan harga BBM otomatis, yang sempat dihentikan sementara di tengah gejolak ekonomi dan tekanan geopolitik regional, akan kembali diaktifkan untuk menyesuaikan harga BBM domestik secara berkala berdasarkan pergerakan harga minyak mentah dunia dan nilai tukar pound Mesir terhadap dolar AS.</p><p>Langkah ini merupakan bagian dari komitmen Mesir terhadap program reformasi struktural yang disepakati bersama IMF, yang mensyaratkan pengurangan bertahap subsidi energi guna mengurangi beban fiskal negara. Pemerintah menegaskan bahwa penyesuaian harga akan tetap mempertimbangkan daya beli masyarakat, dengan skema bantuan sosial bagi kelompok rentan tetap dipertahankan.</p><p>Kebijakan ini disambut beragam oleh publik Mesir, dengan sebagian pihak mengapresiasi transparansi mekanisme penetapan harga yang lebih dapat diprediksi, sementara kelompok lain mengkhawatirkan dampak kenaikan harga BBM terhadap biaya hidup yang sudah tertekan akibat inflasi tinggi dalam beberapa tahun terakhir.</p>',
            source: 'Ahram Online',
            sourceUrl: 'https://english.ahram.org.eg/',
            sourceSnippet: 'Egypt to reinstate quarterly fuel price review mechanism in Q1 of FY26/27: PM Madbouly — Ahram Online'
          },
          en: {
            title: "Egypt Reinstates Quarterly Fuel Price Review Mechanism Starting Q1 of FY26/27",
            desc: "Egyptian PM Mostafa Madbouly announced the reinstatement of the automatic quarterly fuel price review mechanism starting the first quarter of fiscal year 2026/2027.",
            content: "<p>Egyptian Prime Minister Mostafa Madbouly announced that the government will reinstate the automatic quarterly fuel price review mechanism starting the first quarter of fiscal year 2026/2027. This policy marks a continuation of the energy subsidy reform agenda that has been an important part of Egypt's economic stabilization program in recent years.</p><p>The automatic fuel pricing committee, which had been temporarily suspended amid economic turbulence and regional geopolitical pressure, will be reactivated to periodically adjust domestic fuel prices based on world crude oil price movements and the Egyptian pound's exchange rate against the US dollar.</p><p>This move is part of Egypt's commitment to the structural reform program agreed with the IMF, which requires gradual reduction of energy subsidies to reduce the state's fiscal burden. The government affirmed that price adjustments will continue to consider public purchasing power, with social assistance schemes for vulnerable groups maintained.</p><p>This policy received mixed reception from the Egyptian public, with some appreciating the more predictable transparency of the pricing mechanism, while others worry about the impact of fuel price increases on living costs already strained by high inflation in recent years.</p>",
            source: 'Ahram Online',
            sourceUrl: 'https://english.ahram.org.eg/',
            sourceSnippet: 'Egypt to reinstate quarterly fuel price review mechanism in Q1 of FY26/27: PM Madbouly — Ahram Online'
          },
          ja: {
            title: 'エジプト、2026/27会計年度第1四半期から燃料価格四半期見直し制度を再開',
            desc: 'エジプトのマドブーリ首相は2026/27会計年度第1四半期から自動燃料価格四半期見直し制度の再開を発表した。',
            content: '<p>エジプトのモスタファ・マドブーリ首相は、政府が2026/27会計年度第1四半期から自動燃料価格四半期見直し制度を再開すると発表しました。この政策は近年エジプトの経済安定化プログラムの重要な一部となってきたエネルギー補助金改革アジェンダの継続を示すものです。</p><p>経済的混乱と地域の地政学的圧力の中で一時停止されていた自動燃料価格設定委員会は、世界の原油価格動向とエジプトポンドの対米ドル為替レートに基づき国内燃料価格を定期的に調整するため再稼働されます。</p><p>この措置はIMFと合意した構造改革プログラムへのエジプトのコミットメントの一環であり、国家の財政負担軽減のためエネルギー補助金の段階的削減を求めるものです。政府は価格調整が引き続き国民の購買力を考慮したものになると強調し、脆弱層向け社会支援制度は維持されるとしています。</p>',
            source: 'Ahram Online',
            sourceUrl: 'https://english.ahram.org.eg/',
            sourceSnippet: 'エジプト、26/27年度第1四半期から燃料価格四半期見直し制度再開：マドブーリ首相 — Ahram Online'
          },
          ko: {
            title: '이집트, 2026/27 회계연도 1분기부터 분기별 유가 검토 제도 재도입',
            desc: '이집트 마드불리 총리는 2026/27 회계연도 1분기부터 자동 분기별 유가 검토 제도 재도입을 발표했다.',
            content: '<p>이집트 무스타파 마드불리 총리는 정부가 2026/27 회계연도 1분기부터 자동 분기별 유가 검토 제도를 재도입할 것이라고 발표했습니다. 이 정책은 최근 몇 년간 이집트 경제 안정화 프로그램의 중요한 부분이었던 에너지 보조금 개혁 의제의 연속을 나타냅니다.</p><p>경제적 혼란과 지역 지정학적 압박 속에서 일시 중단되었던 자동 연료 가격 책정 위원회는 세계 원유 가격 동향과 이집트 파운드의 미 달러 대비 환율을 기반으로 국내 연료 가격을 정기적으로 조정하기 위해 재가동됩니다.</p><p>이 조치는 국가의 재정 부담을 줄이기 위해 에너지 보조금의 점진적 감축을 요구하는 IMF와 합의한 구조 개혁 프로그램에 대한 이집트의 약속의 일환입니다. 정부는 가격 조정이 계속해서 대중의 구매력을 고려할 것이며, 취약 계층을 위한 사회 지원 제도는 유지될 것이라고 확인했습니다.</p>',
            source: 'Ahram Online',
            sourceUrl: 'https://english.ahram.org.eg/',
            sourceSnippet: '이집트, 26/27년도 1분기부터 분기별 유가 검토 제도 재도입: 마드불리 총리 — Ahram Online'
          },
          zh: {
            title: '埃及从2026/27财年第一季度起恢复季度燃油价格审查机制',
            desc: '埃及总理马德布利宣布从2026/27财年第一季度起恢复自动季度燃油价格审查机制。',
            content: '<p>埃及总理穆斯塔法·马德布利宣布，政府将从2026/27财年第一季度起恢复自动季度燃油价格审查机制。该政策标志着近年来作为埃及经济稳定计划重要组成部分的能源补贴改革议程的延续。</p><p>此前因经济动荡和地区地缘政治压力而暂停的自动燃油定价委员会，将重新启动，根据世界原油价格走势和埃及镑兑美元汇率定期调整国内燃油价格。</p><p>此举是埃及履行与IMF商定的结构性改革计划承诺的一部分，该计划要求逐步削减能源补贴以减轻国家财政负担。政府确认，价格调整仍将考虑公众购买力，并将维持针对弱势群体的社会援助计划。</p>',
            source: 'Ahram Online',
            sourceUrl: 'https://english.ahram.org.eg/',
            sourceSnippet: '埃及总理马德布利：将从26/27财年第一季度恢复季度燃油价格审查机制 — Ahram Online'
          }
        }
      },
      {
        id: 'mesir-trump-sisi-gerd-17juni2026',
        langs: {
          id: {
            title: 'Trump Sinyalkan Dorongan Baru Selesaikan Sengketa Bendungan GERD dalam Pertemuan dengan El-Sisi',
            desc: 'Presiden AS Donald Trump memberi sinyal dorongan baru untuk menyelesaikan sengketa Grand Ethiopian Renaissance Dam (GERD) dalam pertemuannya dengan Presiden Mesir Abdel Fattah El-Sisi pada 17 Juni 2026.',
            content: '<p>Presiden Amerika Serikat Donald Trump memberikan sinyal dorongan diplomatik baru untuk menyelesaikan sengketa panjang seputar Grand Ethiopian Renaissance Dam (GERD) dalam pertemuannya dengan Presiden Mesir Abdel Fattah El-Sisi pada 17 Juni 2026. Trump menyatakan bahwa Mesir telah "diperlakukan tidak adil" terkait dampak bendungan tersebut terhadap Sungai Nil, sumber air krusial bagi kehidupan dan perekonomian Mesir.</p><p>GERD, bendungan senilai 5 miliar dolar AS yang dibangun Ethiopia di hulu Sungai Nil Biru, telah lama menjadi sumber ketegangan diplomatik antara Ethiopia, Mesir, dan Sudan sejak proses pembangunannya dimulai. Mesir dan Sudan telah berulang kali menyuarakan kekhawatiran bahwa bendungan tersebut dapat mengancam pasokan air vital yang menjadi tulang punggung kehidupan jutaan penduduk di kedua negara hilir tersebut.</p><p>Menurut analisis regional, pernyataan El-Sisi mengenai GERD pada April 2026 dinilai strategis, mengingat bendungan tersebut kini telah beroperasi penuh dalam mode pembangkit listrik tenaga air dan manajemen banjir, sementara perekonomian Mesir tengah menghadapi tekanan berat yang membuat isu keamanan air menjadi semakin krusial bagi stabilitas jangka panjang negara tersebut.</p><p>Dukungan diplomatik AS terhadap posisi Mesir dalam sengketa GERD ini berpotensi membuka jalur negosiasi baru antara ketiga negara, meski para pengamat memperingatkan bahwa penyelesaian menyeluruh atas sengketa yang telah berlangsung lebih dari satu dekade ini masih memerlukan komitmen politik yang kuat dari seluruh pihak yang terlibat.</p>',
            source: 'Egypt Today',
            sourceUrl: 'https://www.egypttoday.com/Tag/33230/Grand-Ethiopian-Renaissance-Dam',
            sourceSnippet: 'Trump signals fresh push to resolve GERD dispute in meeting with El-Sisi — Egypt Today, June 17, 2026',
            source2: 'Horn Review',
            sourceUrl2: 'https://hornreview.org/2026/04/08/el-sisis-recent-rhetoric-on-gerd/',
            sourceSnippet2: "El-Sisi's recent rhetoric on GERD, dam now in full hydropower and flood-management mode — Horn Review, April 2026"
          },
          en: {
            title: "Trump Signals Fresh Push to Resolve GERD Dam Dispute in Meeting with El-Sisi",
            desc: "US President Donald Trump signaled a fresh diplomatic push to resolve the long-running Grand Ethiopian Renaissance Dam (GERD) dispute in a meeting with Egyptian President Abdel Fattah El-Sisi on June 17, 2026.",
            content: "<p>US President Donald Trump signaled a fresh diplomatic push to resolve the long-running dispute surrounding the Grand Ethiopian Renaissance Dam (GERD) in a meeting with Egyptian President Abdel Fattah El-Sisi on June 17, 2026. Trump stated Egypt had been 'unfairly treated' regarding the dam's impact on the Nile River, a critical water source for Egypt's life and economy.</p><p>GERD, a $5 billion dam built by Ethiopia on the Blue Nile's upper reaches, has long been a source of diplomatic tension between Ethiopia, Egypt, and Sudan since construction began. Egypt and Sudan have repeatedly voiced concerns that the dam could threaten the vital water supply forming the backbone of life for millions of residents in both downstream countries.</p><p>According to regional analysis, El-Sisi's statements on GERD in April 2026 were considered strategic, given the dam is now fully operational in hydropower generation and flood-management mode, while Egypt's economy faces heavy pressure making water security an increasingly critical issue for the country's long-term stability.</p><p>US diplomatic support for Egypt's position in the GERD dispute could open new negotiation channels among the three countries, though observers caution that a comprehensive resolution to this dispute, ongoing for over a decade, still requires strong political commitment from all parties involved.</p>",
            source: 'Egypt Today',
            sourceUrl: 'https://www.egypttoday.com/Tag/33230/Grand-Ethiopian-Renaissance-Dam',
            sourceSnippet: 'Trump signals fresh push to resolve GERD dispute in meeting with El-Sisi — Egypt Today, June 17, 2026',
            source2: 'Horn Review',
          ...
          ja: {
            title: 'トランプ氏、エルシーシ大統領との会談でGERDダム紛争解決へ新たな推進を示唆',
            desc: 'トランプ米大統領は2026年6月17日、エルシーシ・エジプト大統領との会談で長期化するグランド・エチオピア・ルネッサンスダム（GERD）紛争解決への新たな外交的推進を示唆した。',
            content: '<p>トランプ米大統領は2026年6月17日、エルシーシ・エジプト大統領との会談で、長年続くグランド・エチオピア・ルネッサンスダム（GERD）を巡る紛争解決への新たな外交的推進を示唆しました。トランプ氏は、ナイル川へのダムの影響に関してエジプトが「不当に扱われてきた」と述べ、ナイル川はエジプトの生活と経済にとって不可欠な水源です。</p><p>エチオピアが青ナイル上流に建設した50億ドル規模のGERDは、建設開始以来、エチオピア、エジプト、スーダン間の長年の外交的緊張の源となってきました。エジプトとスーダンは、このダムが両下流国の数百万人の住民の生活の基盤となる重要な水供給を脅かす可能性があると繰り返し懸念を表明してきました。</p>',
            source: 'Egypt Today',
            sourceUrl: 'https://www.egypttoday.com/Tag/33230/Grand-Ethiopian-Renaissance-Dam',
            sourceSnippet: 'トランプ氏、エルシーシ氏との会談でGERD紛争解決へ新推進を示唆 — Egypt Today、2026年6月17日',
            source2: 'Horn Review',
            sourceUrl2: 'https://hornreview.org/2026/04/08/el-sisis-recent-rhetoric-on-gerd/',
            sourceSnippet2: 'エルシーシ氏のGERDに関する最近の発言、ダムは水力発電・洪水管理フルモードに — Horn Review、2026年4月'
          },
          ko: {
            title: '트럼프, 엘시시 대통령과의 회담에서 GERD 댐 분쟁 해결 위한 새로운 추진 시사',
            desc: '트럼프 미국 대통령은 2026년 6월 17일 엘시시 이집트 대통령과의 회담에서 장기화된 그랜드 에티오피아 르네상스댐(GERD) 분쟁 해결을 위한 새로운 외교적 추진을 시사했다.',
            content: '<p>트럼프 미국 대통령은 2026년 6월 17일 엘시시 이집트 대통령과의 회담에서 나일강에 대한 댐의 영향과 관련해 이집트가 "부당한 대우를 받았다"고 언급하며, 오랫동안 계속된 그랜드 에티오피아 르네상스댐(GERD) 분쟁 해결을 위한 새로운 외교적 추진을 시사했습니다. 나일강은 이집트의 삶과 경제에 필수적인 수원입니다.</p><p>에티오피아가 청나일강 상류에 건설한 50억 달러 규모의 GERD는 건설이 시작된 이래 에티오피아, 이집트, 수단 간의 오랜 외교적 긴장의 원천이었습니다. 이집트와 수단은 이 댐이 두 하류 국가 수백만 주민의 생명의 근간이 되는 필수 수자원 공급을 위협할 수 있다고 반복적으로 우려를 표명해 왔습니다.</p>',
            source: 'Egypt Today',
            sourceUrl: 'https://www.egypttoday.com/Tag/33230/Grand-Ethiopian-Renaissance-Dam',
            sourceSnippet: '트럼프, 엘시시와의 회담에서 GERD 분쟁 해결 위한 새 추진 시사 — Egypt Today, 2026년 6월 17일',
            source2: 'Horn Review',
            sourceUrl2: 'https://hornreview.org/2026/04/08/el-sisis-recent-rhetoric-on-gerd/',
            sourceSnippet2: '엘시시의 GERD 관련 최근 발언, 댐 완전 수력발전·홍수관리 모드로 전환 — Horn Review, 2026년 4월'
          },
          zh: {
            title: '特朗普在与塞西会晤中示意重新推动解决GERD大坝争端',
            desc: '美国总统特朗普于2026年6月17日在与埃及总统塞西的会晤中示意将重新推动解决长期存在的大埃塞俄比亚复兴大坝（GERD）争端。',
            content: '<p>美国总统特朗普于2026年6月17日在与埃及总统阿卜杜勒·法塔赫·塞西的会晤中示意将重新推动解决围绕大埃塞俄比亚复兴大坝（GERD）的长期争端。特朗普表示，就大坝对尼罗河的影响而言，埃及一直受到"不公平对待"，尼罗河是埃及生命和经济的重要水源。</p><p>GERD是埃塞俄比亚在青尼罗河上游修建的耗资50亿美元的大坝，自开工建设以来长期是埃塞俄比亚、埃及和苏丹之间外交紧张的根源。埃及和苏丹多次表示担忧，认为该大坝可能威胁到构成两个下游国家数百万居民生命支柱的重要供水。</p>',
            source: 'Egypt Today',
            sourceUrl: 'https://www.egypttoday.com/Tag/33230/Grand-Ethiopian-Renaissance-Dam',
            sourceSnippet: '特朗普在与塞西会晤中示意重新推动解决GERD争端 — Egypt Today，2026年6月17日',
            source2: 'Horn Review',
            sourceUrl2: 'https://hornreview.org/2026/04/08/el-sisis-recent-rhetoric-on-gerd/',
            sourceSnippet2: '塞西关于GERD的最新表态，大坝现已全面进入水电与防洪管理模式 — Horn Review，2026年4月'
          }
        }
      },
      {
        id: 'mesir-grand-egyptian-museum-7juta-pengunjung',
        langs: {
          id: {
            title: 'Grand Egyptian Museum Catat 7 Juta Pengunjung sejak Dibuka November 2025',
            desc: 'Grand Egyptian Museum (GEM) yang menelan biaya lebih dari 1 miliar dolar AS mencatat lebih dari 7 juta pengunjung sejak resmi dibuka November 2025, menjadikannya salah satu daya tarik wisata utama Mesir.',
            content: '<p>Grand Egyptian Museum (GEM) di Giza telah menyambut lebih dari 7 juta pengunjung sejak resmi dibuka pada November 2025, menegaskan posisinya sebagai salah satu permata pariwisata terbaru Mesir. Museum yang menelan biaya pembangunan lebih dari 1 miliar dolar AS dan proses pembangunan selama lebih dari dua dekade ini menampilkan koleksi artefak Mesir kuno terlengkap yang pernah dipamerkan dalam satu lokasi.</p><p>Pembukaan GEM menjadi puncak dari proyek ambisius yang telah lama dinanti, dengan museum ini kini menjadi rumah bagi koleksi lengkap harta karun Firaun Tutankhamun serta ribuan artefak bersejarah lainnya yang sebelumnya tersebar di berbagai museum kecil di seluruh Mesir. Lokasinya yang strategis di dekat kompleks Piramida Giza turut memperkuat daya tarik wisata kawasan tersebut secara keseluruhan.</p><p>Pemerintah Mesir memandang kesuksesan GEM sebagai bagian penting dari strategi diversifikasi ekonomi nasional, mengingat sektor pariwisata telah lama menjadi salah satu sumber devisa utama negara tersebut di tengah tantangan ekonomi makro yang masih membebani anggaran nasional. Lonjakan jumlah wisatawan turut memberikan dampak positif bagi sektor perhotelan, transportasi, dan usaha kecil menengah di sekitar kawasan Giza.</p><p>Dengan capaian 7 juta pengunjung dalam waktu kurang dari delapan bulan sejak pembukaan, GEM diproyeksikan akan terus menjadi salah satu pendorong utama pertumbuhan sektor pariwisata Mesir dalam beberapa tahun mendatang, seiring upaya pemerintah memperluas promosi wisata budaya dan sejarah ke pasar internasional yang lebih luas.</p>',
            source: 'Forbes',
            sourceUrl: 'https://www.forbes.com/sites/michaelgoldstein/2026/06/12/the-new-grand-egyptian-museum-is-just-one-of-egyptians-tourism-gems/',
            sourceSnippet: 'The new Grand Egyptian Museum has shown the history and culture of Egypt to seven million people since opening in November 2025 — Forbes, June 12, 2026',
            source2: 'CNN International',
            sourceUrl2: 'https://www.facebook.com/cnninternational/videos/after-more-than-1-billion-and-two-decades-later-the-grand-egyptian-museum-has-op/680683674760598/',
            sourceSnippet2: 'After more than $1 billion and two decades later, the Grand Egyptian Museum has opened — CNN International'
          },
          en: {
            title: 'Grand Egyptian Museum Records 7 Million Visitors Since Opening in November 2025',
            desc: 'The Grand Egyptian Museum (GEM), costing over $1 billion, has recorded over 7 million visitors since officially opening in November 2025, making it one of Egypt\'s major tourist attractions.',
            content: "<p>The Grand Egyptian Museum (GEM) in Giza has welcomed over 7 million visitors since officially opening in November 2025, affirming its position as one of Egypt's newest tourism gems. The museum, costing over $1 billion to build and taking more than two decades to construct, showcases the most complete collection of ancient Egyptian artifacts ever displayed in one location.</p><p>GEM's opening marked the culmination of a long-awaited ambitious project, with the museum now home to the complete collection of Pharaoh Tutankhamun's treasures along with thousands of other historical artifacts previously scattered across various smaller museums throughout Egypt. Its strategic location near the Giza Pyramid complex further strengthens the region's overall tourism appeal.</p><p>Egypt's government views GEM's success as an important part of its national economic diversification strategy, given the tourism sector has long been one of the country's main sources of foreign currency amid macroeconomic challenges still burdening the national budget. The surge in tourist numbers has also positively impacted the hospitality, transportation, and small-medium business sectors around the Giza area.</p><p>With 7 million visitors achieved in less than eight months since opening, GEM is projected to continue being one of the main drivers of Egypt's tourism sector growth in coming years, alongside government efforts to expand cultural and historical tourism promotion to broader international markets.</p>",
            source: 'Forbes',
            sourceUrl: 'https://www.forbes.com/sites/michaelgoldstein/2026/06/12/the-new-grand-egyptian-museum-is-just-one-of-egyptians-tourism-gems/',
            sourceSnippet: 'The new Grand Egyptian Museum has shown the history and culture of Egypt to seven million people since opening in November 2025 — Forbes, June 12, 2026',
            source2: 'CNN International',
          ...
          ja: {
            title: 'グランド・エジプシャン・ミュージアム、2025年11月開館以来700万人来場',
            desc: '10億ドル超を投じたグランド・エジプシャン・ミュージアム（GEM）は2025年11月の正式開館以来700万人以上の来場者を記録、エジプトの主要観光名所の一つとなった。',
            content: '<p>ギザのグランド・エジプシャン・ミュージアム（GEM）は2025年11月の正式開館以来700万人以上の来場者を迎え、エジプト最新の観光の宝石の一つとしての地位を確固たるものにしています。建設費10億ドル超、20年以上の建設期間を要したこの博物館は、一箇所で展示された史上最も完全な古代エジプト遺物コレクションを紹介しています。</p><p>GEMの開館は長らく待ち望まれていた野心的なプロジェクトの集大成であり、同博物館は現在、以前はエジプト各地の小規模博物館に分散していたファラオ・ツタンカーメンの宝物完全コレクションおよび数千点の他の歴史的遺物の本拠地となっています。</p>',
            source: 'Forbes',
            sourceUrl: 'https://www.forbes.com/sites/michaelgoldstein/2026/06/12/the-new-grand-egyptian-museum-is-just-one-of-egyptians-tourism-gems/',
            sourceSnippet: '新グランド・エジプシャン・ミュージアム、2025年11月開館以来700万人にエジプトの歴史と文化を紹介 — Forbes、2026年6月12日',
            source2: 'CNN International',
            sourceUrl2: 'https://www.facebook.com/cnninternational/videos/after-more-than-1-billion-and-two-decades-later-the-grand-egyptian-museum-has-op/680683674760598/',
            sourceSnippet2: '10億ドル超、20年以上を経てグランド・エジプシャン・ミュージアムが開館 — CNN International'
          },
          ko: {
            title: '그랜드 이집트 박물관, 2025년 11월 개관 이후 방문객 700만 명 기록',
            desc: '10억 달러 이상이 투입된 그랜드 이집트 박물관(GEM)은 2025년 11월 공식 개관 이후 700만 명 이상의 방문객을 기록하며 이집트의 주요 관광 명소 중 하나가 되었다.',
            content: '<p>기자에 위치한 그랜드 이집트 박물관(GEM)은 2025년 11월 공식 개관 이후 700만 명 이상의 방문객을 맞이하며 이집트의 최신 관광 보석 중 하나로서의 위치를 확고히 했습니다. 건설 비용 10억 달러 이상, 20년 이상의 건설 기간이 소요된 이 박물관은 한 장소에 전시된 사상 가장 완전한 고대 이집트 유물 컬렉션을 선보입니다.</p><p>GEM의 개관은 오랫동안 기다려온 야심찬 프로젝트의 정점이었으며, 이 박물관은 현재 이전에는 이집트 전역의 여러 소규모 박물관에 흩어져 있던 파라오 투탕카멘의 보물 전체 컬렉션과 수천 점의 다른 역사적 유물의 본거지가 되었습니다.</p>',
            source: 'Forbes',
            sourceUrl: 'https://www.forbes.com/sites/michaelgoldstein/2026/06/12/the-new-grand-egyptian-museum-is-just-one-of-egyptians-tourism-gems/',
            sourceSnippet: '새 그랜드 이집트 박물관, 2025년 11월 개관 이후 700만 명에게 이집트 역사와 문화 소개 — Forbes, 2026년 6월 12일',
            source2: 'CNN International',
            sourceUrl2: 'https://www.facebook.com/cnninternational/videos/after-more-than-1-billion-and-two-decades-later-the-grand-egyptian-museum-has-op/680683674760598/',
            sourceSnippet2: '10억 달러 이상, 20년 이상 만에 그랜드 이집트 박물관 개관 — CNN International'
          },
          zh: {
            title: '大埃及博物馆自2025年11月开馆以来已接待700万游客',
            desc: '耗资超过10亿美元的大埃及博物馆（GEM）自2025年11月正式开馆以来已接待超过700万游客，成为埃及主要旅游景点之一。',
            content: '<p>位于吉萨的大埃及博物馆（GEM）自2025年11月正式开馆以来已接待超过700万游客，巩固了其作为埃及最新旅游瑰宝之一的地位。这座博物馆建造耗资超过10亿美元，建设历时二十多年，展示了有史以来在单一地点展出的最完整的古埃及文物收藏。</p><p>GEM的开馆是一个期待已久的雄心勃勃项目的高潮，该博物馆现已成为法老图坦卡蒙宝藏完整收藏以及数千件此前分散在埃及各地小型博物馆中的其他历史文物的所在地。</p>',
            source: 'Forbes',
            sourceUrl: 'https://www.forbes.com/sites/michaelgoldstein/2026/06/12/the-new-grand-egyptian-museum-is-just-one-of-egyptians-tourism-gems/',
            sourceSnippet: '新大埃及博物馆自2025年11月开馆以来已向700万人展示埃及历史与文化 — Forbes，2026年6月12日',
            source2: 'CNN International',
            sourceUrl2: 'https://www.facebook.com/cnninternational/videos/after-more-than-1-billion-and-two-decades-later-the-grand-egyptian-museum-has-op/680683674760598/',
            sourceSnippet2: '耗资超10亿美元、历时二十余年，大埃及博物馆终于开馆 — CNN International'
          }
        }
      },
      {
        id: 'mesir-rafah-ditutup-israel-1maret2026',
        langs: {
          id: {
            title: 'Israel Tutup Perbatasan Rafah dengan Mesir di Tengah Serangan terhadap Iran',
            desc: 'Israel menutup perlintasan perbatasan Rafah dengan Mesir pada 1 Maret 2026 di tengah serangan gabungan Israel-Amerika Serikat terhadap Iran, memicu kekhawatiran baru terkait akses kemanusiaan bagi warga Gaza.',
            content: '<p>Israel menutup kembali perlintasan perbatasan Rafah antara Jalur Gaza dan Mesir pada 1 Maret 2026, di tengah eskalasi serangan gabungan Israel dan Amerika Serikat terhadap Iran. Otoritas keamanan Israel menyatakan bahwa penutupan ini merupakan bagian dari "langkah keamanan yang diperlukan" mengingat situasi regional yang tengah memanas akibat konflik dengan Iran.</p><p>Perlintasan Rafah sebelumnya sempat dibuka kembali secara terbatas pada awal Februari 2026 sebagai bagian dari perjanjian gencatan senjata di Gaza yang difasilitasi mediasi internasional, memungkinkan sejumlah kecil warga Palestina termasuk evakuasi medis untuk melintasi perbatasan menuju Mesir setelah bertahun-tahun akses yang sangat terbatas sejak penutupan besar-besaran pada Mei 2024.</p><p>Penutupan kembali perbatasan ini memicu kekhawatiran baru di kalangan organisasi kemanusiaan internasional mengenai akses bantuan dan evakuasi medis bagi warga Gaza yang masih membutuhkan penanganan mendesak. Mesir, yang telah lama berperan sebagai mediator dan jalur kemanusiaan utama bagi Gaza, kembali menghadapi tantangan diplomatik dalam menjaga stabilitas kawasan perbatasan Sinai Utara di tengah ketidakpastian geopolitik regional yang terus berlanjut.</p><p>Situasi ini menambah kompleksitas tantangan yang dihadapi Mesir dalam menyeimbangkan kepentingan keamanan nasional, hubungan diplomatik dengan Israel dan negara-negara Barat, serta komitmen kemanusiaan terhadap rakyat Palestina yang terus menjadi perhatian utama kebijakan luar negeri Mesir di kawasan Timur Tengah.</p>',
            source: 'Al Jazeera',
            sourceUrl: 'https://www.aljazeera.com/news/2026/3/1/israel-closes-gazas-rafah-crossing-amid-attacks-on-iran',
            sourceSnippet: "Israel closes Gaza's Rafah crossing amid attacks on Iran — Al Jazeera, March 1, 2026",
            source2: 'The Guardian',
            sourceUrl2: 'https://www.theguardian.com/world/live/2026/feb/02/rafah-border-egypt-gaza-israel-opens-crossing-latest-news-updates',
            sourceSnippet2: 'First medical evacuee leaves Gaza as Rafah crossing reopens for handful of Palestinians — The Guardian, February 2, 2026'
          },
          en: {
            title: "Israel Closes Rafah Border Crossing with Egypt Amid Attacks on Iran",
            desc: "Israel closed the Rafah border crossing with Egypt on March 1, 2026, amid joint Israeli-US attacks on Iran, raising fresh concerns over humanitarian access for Gaza residents.",
            content: "<p>Israel reclosed the Rafah border crossing between the Gaza Strip and Egypt on March 1, 2026, amid escalating joint Israeli-US attacks on Iran. Israeli security authorities stated the closure was part of 'necessary security measures' given the heating regional situation due to the conflict with Iran.</p><p>The Rafah crossing had previously reopened on a limited basis in early February 2026 as part of a Gaza ceasefire agreement facilitated by international mediation, allowing a small number of Palestinians including medical evacuees to cross the border into Egypt following years of severely limited access since the major closure in May 2024.</p><p>This border reclosure has raised fresh concerns among international humanitarian organizations regarding aid access and medical evacuation for Gaza residents still requiring urgent care. Egypt, which has long served as a mediator and key humanitarian channel for Gaza, again faces diplomatic challenges in maintaining stability in the North Sinai border region amid ongoing regional geopolitical uncertainty.</p><p>This situation adds to the complexity of challenges facing Egypt in balancing national security interests, diplomatic relations with Israel and Western countries, and humanitarian commitments toward the Palestinian people that continue to be a central concern of Egypt's foreign policy in the Middle East region.</p>",
            source: 'Al Jazeera',
            sourceUrl: 'https://www.aljazeera.com/news/2026/3/1/israel-closes-gazas-rafah-crossing-amid-attacks-on-iran',
            sourceSnippet: "Israel closes Gaza's Rafah crossing amid attacks on Iran — Al Jazeera, March 1, 2026",
            source2: 'The Guardian',
          ...
          ja: {
            title: 'イスラエル、イラン攻撃の最中エジプトとのラファ検問所を閉鎖',
            desc: 'イスラエルは2026年3月1日、イランへのイスラエル・米国合同攻撃の最中にエジプトとのラファ検問所を閉鎖、ガザ住民への人道アクセスへの新たな懸念を引き起こした。',
            content: '<p>イスラエルは2026年3月1日、イランへのイスラエル・米国合同攻撃が激化する中、ガザ地区とエジプトの間のラファ検問所を再度閉鎖しました。イスラエル治安当局は、イランとの紛争による地域情勢の緊迫化を受けた「必要な安全対策」の一環だとしています。</p><p>ラファ検問所は2026年2月初旬、国際的な仲介により実現したガザ停戦合意の一環として限定的に再開されており、2024年5月の大規模閉鎖以来長年極めて限定的だったアクセスの後、医療避難民を含む少数のパレスチナ人がエジプトへの国境越えを許可されていました。</p>',
            source: 'Al Jazeera',
            sourceUrl: 'https://www.aljazeera.com/news/2026/3/1/israel-closes-gazas-rafah-crossing-amid-attacks-on-iran',
            sourceSnippet: 'イスラエル、イラン攻撃の最中ガザのラファ検問所を閉鎖 — Al Jazeera、2026年3月1日',
            source2: 'The Guardian',
            sourceUrl2: 'https://www.theguardian.com/world/live/2026/feb/02/rafah-border-egypt-gaza-israel-opens-crossing-latest-news-updates',
            sourceSnippet2: 'ラファ検問所再開で最初の医療避難民がガザを出国 — The Guardian、2026年2月2日'
          },
          ko: {
            title: '이스라엘, 이란 공격 와중에 이집트와의 라파 국경 검문소 폐쇄',
            desc: '이스라엘은 2026년 3월 1일 이란에 대한 이스라엘-미국 합동 공격 와중에 이집트와의 라파 국경 검문소를 폐쇄, 가자 주민들의 인도적 접근에 대한 새로운 우려를 불러일으켰다.',
            content: '<p>이스라엘은 2026년 3월 1일, 이란에 대한 이스라엘-미국 합동 공격이 격화되는 가운데 가자지구와 이집트 사이의 라파 국경 검문소를 다시 폐쇄했습니다. 이스라엘 보안 당국은 이란과의 갈등으로 인한 지역 정세 긴장을 고려한 "필요한 안보 조치"의 일환이라고 밝혔습니다.</p><p>라파 검문소는 2026년 2월 초 국제 중재로 성사된 가자 휴전 협정의 일환으로 제한적으로 재개방되어, 2024년 5월 대규모 폐쇄 이후 수년간 매우 제한적이었던 접근 이후 의료 후송자를 포함한 소수의 팔레스타인인들이 이집트로 국경을 넘을 수 있도록 허용했습니다.</p>',
            source: 'Al Jazeera',
            sourceUrl: 'https://www.aljazeera.com/news/2026/3/1/israel-closes-gazas-rafah-crossing-amid-attacks-on-iran',
            sourceSnippet: '이스라엘, 이란 공격 와중 가자 라파 검문소 폐쇄 — Al Jazeera, 2026년 3월 1일',
            source2: 'The Guardian',
            sourceUrl2: 'https://www.theguardian.com/world/live/2026/feb/02/rafah-border-egypt-gaza-israel-opens-crossing-latest-news-updates',
            sourceSnippet2: '라파 검문소 재개방으로 첫 의료 후송자 가자 떠나 — The Guardian, 2026년 2월 2일'
          },
          zh: {
            title: '以色列在对伊朗发动攻击之际关闭与埃及的拉法过境点',
            desc: '以色列于2026年3月1日在以色列与美国联合打击伊朗之际关闭了与埃及的拉法过境点，引发对加沙居民人道主义准入的新担忧。',
            content: '<p>以色列于2026年3月1日在以色列与美国对伊朗的联合打击不断升级之际，再次关闭了加沙地带与埃及之间的拉法过境点。以色列安全当局表示，鉴于伊朗冲突导致地区局势升温，此次关闭是"必要安全措施"的一部分。</p><p>拉法过境点此前于2026年2月初在国际斡旋促成的加沙停火协议框架下有限度重新开放，允许包括医疗后送人员在内的少数巴勒斯坦人越境进入埃及，此前自2024年5月大规模关闭以来，通行一直极为有限。</p>',
            source: 'Al Jazeera',
            sourceUrl: 'https://www.aljazeera.com/news/2026/3/1/israel-closes-gazas-rafah-crossing-amid-attacks-on-iran',
            sourceSnippet: '以色列在对伊朗发动攻击之际关闭加沙拉法过境点 — Al Jazeera，2026年3月1日',
            source2: 'The Guardian',
            sourceUrl2: 'https://www.theguardian.com/world/live/2026/feb/02/rafah-border-egypt-gaza-israel-opens-crossing-latest-news-updates',
            sourceSnippet2: '拉法过境点重新开放，首名医疗后送人员离开加沙 — The Guardian，2026年2月2日'
          }
        }
      },
      {
        id: 'mesir-layanan-skck-online-diaspora-2026',
        langs: {
          id: {
            title: 'Mesir Luncurkan Layanan Online Surat Keterangan Catatan Kriminal untuk Warga di Luar Negeri',
            desc: 'Pemerintah Mesir resmi meluncurkan layanan konsuler digital yang memungkinkan warga Mesir di luar negeri mengajukan SKCK kedua secara online lewat Digital Egypt Portal.',
            content: '<p>Pemerintah Mesir resmi meluncurkan layanan konsuler elektronik baru yang memungkinkan warga negara Mesir yang tinggal di luar negeri untuk mengajukan penerbitan surat keterangan catatan kriminal (SKCK) kedua secara otomatis dan online. Layanan ini diumumkan pada Rabu, 1 Juli 2026, dan dapat diakses melalui Digital Egypt Portal tanpa perlu mendatangi kedutaan atau konsulat secara langsung.</p><p>Menurut laporan Ahram Online, warga Mesir di luar negeri kini dapat memperoleh dokumen tersebut asalkan mereka sudah pernah mengurus SKCK pertama secara konvensional sebelumnya. Sistem baru ini dirancang untuk memangkas waktu tunggu yang sebelumnya bisa memakan waktu berminggu-minggu karena harus melalui proses manual di kantor perwakilan Mesir di negara masing-masing.</p><p>CairoScene melaporkan bahwa langkah ini merupakan bagian dari upaya lebih luas Kementerian Luar Negeri Mesir untuk mendigitalisasi layanan konsuler bagi diaspora Mesir yang tersebar di berbagai negara. Proses pengajuan meliputi verifikasi identitas digital, pembayaran biaya administrasi daring, dan pengiriman dokumen resmi melalui portal yang sama.</p><p>Langkah ini menyusul inisiatif digitalisasi layanan publik Mesir lainnya, termasuk perluasan kanal pengaduan warga melalui WhatsApp dan platform digital yang diumumkan pada pekan yang sama. Pemerintah menyebut transformasi digital ini sebagai bagian dari strategi Mesir untuk mempermudah akses layanan publik tanpa mengurangi standar keamanan verifikasi dokumen.</p><p>Kalangan diaspora Mesir menyambut baik kebijakan ini, khususnya mereka yang bekerja atau menempuh pendidikan di luar negeri dan sebelumnya kesulitan mengurus dokumen legal dari jarak jauh. Kementerian menyatakan akan terus memperluas jenis layanan konsuler yang bisa diakses secara digital pada tahap berikutnya.</p>',
            source: 'Ahram Online',
            sourceUrl: 'https://english.ahram.org.eg/NewsContentP/1/571910/Egypt/Egypt-launches-online-criminal-record-certificate-.aspx',
            sourceSnippet: 'Egypt launches online criminal record certificate service for citizens abroad — Ahram Online, 1 Juli 2026',
            source2: 'CairoScene',
            sourceUrl2: 'https://cairoscene.com/News/Egyptians-Abroad-Can-Now-Get-Second-Criminal-Record-Certificate-Online',
            sourceSnippet2: 'Egyptians Abroad Can Now Get Second Criminal Record Certificate Online — CairoScene',
            source3: 'Ahram Online',
            sourceUrl3: 'https://english.ahram.org.eg/NewsContent/1/2/571908/Egypt/Society/Egypt-moves-citizen-complaints-beyond-hotlines-wit.aspx',
            sourceSnippet3: 'Egypt Moves Citizen Complaints Beyond Hotlines with WhatsApp, Digital Platforms — Ahram Online'
          },
          en: {
            title: 'Egypt Launches Online Criminal Record Certificate Service for Citizens Abroad',
            desc: 'Egypt has launched a new digital consular service letting Egyptians living abroad apply online for a second criminal record certificate via the Digital Egypt Portal.',
            content: '<p>The Egyptian government has officially launched a new electronic consular service allowing Egyptian citizens living abroad to apply for a second automated criminal record certificate online. The service was announced on Wednesday, July 1, 2026, and is accessible through the Digital Egypt Portal without needing to visit an embassy or consulate in person.</p><p>According to Ahram Online, Egyptians abroad can now obtain the document as long as they previously obtained their first certificate through the conventional process. The new system is designed to cut down wait times that previously took weeks due to manual processing at Egyptian representative offices abroad.</p><p>CairoScene reported that the move is part of a broader effort by Egypt\'s Ministry of Foreign Affairs to digitize consular services for the Egyptian diaspora spread across various countries. The application process includes digital identity verification, online administrative fee payment, and delivery of the official document through the same portal.</p><p>The move follows other Egyptian public service digitization initiatives, including an expanded citizen complaint channel through WhatsApp and digital platforms announced the same week. The government says this digital transformation is part of Egypt\'s strategy to simplify access to public services without compromising document verification security standards.</p><p>Members of the Egyptian diaspora have welcomed the policy, particularly those working or studying abroad who previously struggled to process legal documents remotely. The ministry says it will continue expanding the types of consular services accessible digitally in the next phase.</p>',
            source: 'Ahram Online',
            sourceUrl: 'https://english.ahram.org.eg/NewsContentP/1/571910/Egypt/Egypt-launches-online-criminal-record-certificate-.aspx',
            sourceSnippet: 'Egypt launches online criminal record certificate service for citizens abroad — Ahram Online, July 1, 2026',
            source2: 'CairoScene',
            sourceUrl2: 'https://cairoscene.com/News/Egyptians-Abroad-Can-Now-Get-Second-Criminal-Record-Certificate-Online',
            sourceSnippet2: 'Egyptians Abroad Can Now Get Second Criminal Record Certificate Online — CairoScene',
            source3: 'Ahram Online',
